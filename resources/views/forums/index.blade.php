...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <button type="button" class="btn btn-primary font-weight-bold refresh mb-4" data-get="0">Refresh New Message</button>
...
@section('scripts')
    ...
    $(document).on('click','.refresh',function() {
        var test = $(this).attr('data-get');
        $('.refesh').attr('data-get',3);
        load(test)
    });
