            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        <input type="text" class="form-control" name="date" readonly="readonly" id="kt_datepicker_3" value="{{ date("d-m-Y", strtotime($data->date)) }}" />
            ...
            <div class="col-6">        
                <div class="form-group">
                    ...
                    {!! Form::select('project_id', 
                                    $project,null, 
                                    array('class' => 'form-control project_id',"id"=>"project_id","style"=>"width:100%")) !!}
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    ...
                    {!! Form::select('application_id', $application,null, 
                                    array('class' => 'form-control',"id"=>"application_id","style"=>"width:100%")) !!}
                </div>
            </div>
           <div class="col-6">        
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        <input type="text" class="form-control" name="alarm" readonly="readonly" id="kt_timepicker_3" value="{{ date("h:i:s", strtotime($data->alarm)) }}" />
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <i class="la la-calendar"></i>
                            </span>
